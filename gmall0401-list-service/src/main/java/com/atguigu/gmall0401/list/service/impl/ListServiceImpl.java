...
public class ListServiceImpl implements ListService {
    ...
    public void saveSkuLsInfo(SkuLsInfo skuLsInfo) {
        ...
        indexBuilder.index("gmall0401_sku_info").type("doc").id(skuLsInfo.getId());
    ...
    public SkuLsResult getSkuLsInfoList(SkuLsParams skuLsParams) {
        ...
        //聚合
        TermsBuilder aggsBuilder = AggregationBuilders.terms("groupby_value_id").field("skuAttrValueList.valueId.keyword").size(1000);
